# This file is initialized with a code version of some of
# this question's test cases. Feel free to add, edit, or
# remove test cases in this file as you see fit!

import SolutionI_SparseMatrixMultiplication as program
import unittest
...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        ...
        actual = program.sparse_matrix_multiplication(matrix_a, matrix_b)
